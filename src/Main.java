...
public class Main {
    ...
    public static void main(String[] args) {
        File file = new File("E:\\University Semester\\5\\Basics and Application of Artificial Intelligence\\Projects\\Search Project\\Nonogram-Puzzle-CSP\\inputs\\input1.txt");
        Scanner scanner;
